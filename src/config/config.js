...
export const baseUrlUserApi = (environmentVariable === "dev") ? "http://35.226.50.19:8083/user/" : "http://34.87.47.196:8080/user/";
export const baseUrlPartnerApi = (environmentVariable === "dev") ? "http://35.226.50.19:8085/partner" : "http://35.198.202.184:8080/partner";
export const baseUrlOrderApi = (environmentVariable === "dev") ? "http://35.226.50.19:8088/order" : "http://35.186.149.29:8080/order";
export const baseUrlInvoiceApi = (environmentVariable === "dev") ? "http://35.226.50.19:8084/invoice" : "http://35.198.251.69:8080/invoice";
